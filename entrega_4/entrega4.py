...
def lavar_prendas(restricciones, tiempos, diccionario_a_iterar):
    solucion = open("solucion_entrega4.txt", "w")
    numero_lavado = 0
    tiempo_total = 0
    lavadas = set()
...
def main():
    ...
    if (tiempo_total_1 < tiempo_total_2 and tiempo_total_1 < tiempo_total_3): #Vuelvo a correr el mejor metodo para que quede en el archivo de la solucion
        lavar_prendas(restricciones, tiempos, tiempos)
    elif (tiempo_total_2 < tiempo_total_1 and tiempo_total_2 < tiempo_total_3):
        lavar_prendas(restricciones, tiempos, restricciones)
    else:
        lavar_prendas(restricciones, tiempos, scores)
